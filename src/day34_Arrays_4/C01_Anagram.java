...
public class C01_Anagram {
    ...
    // write a method that can check if str1 & str2
    // are build out same characters ANAGRAM

    public static boolean isAnagram(String str1, String str2){
        boolean anagram=false;
        char[] chArr1=str1.toCharArray();
        char[] chArr2=str2.toCharArray();
        System.out.println("Arrays.toString(chArr1) = " + Arrays.toString(chArr1));
        System.out.println("Arrays.toString(chArr2) = " + Arrays.toString(chArr2));
