...
public class C05_MultiDimensionalArrays {
    ...
    public static void main(String[] args) {
        ...
        String [] group1={"arikan","ayşe","dağhan"};
       ...
       // nums2[0][3]=10; // runtime error
        ...
        System.out.println("Arrays.deepToString(nums2) = " + Arrays.deepToString(nums2));
